...
#define FILENAME_TOO_LONG_MSG "File name too long.\n"
...
#define OPEN_FILE_ERR_MSG "File open error.\n"
#define NO_FREE_INODE_MSG "No free inode \n"
#define FS_SIZE_NOT_DEFINED_MSG "File size not defined.\n"
#define FORMAT_SUCCESS_MSG "Format successful.\n"
